#!/bin/bash
# Claude Code Dev Stack v2.1 - Uninstaller Scripts Installer (Linux/WSL)
...
for script in "${scripts[@]}"; do
    ...
    if curl -sL "$url" -o "$UNINSTALLERS_DIR/$script"; then
...
echo "  ./uninstallers/uninstall-all.sh --agents --commands --force"
echo "  ./uninstallers/uninstall-mcps.sh --whatif"
